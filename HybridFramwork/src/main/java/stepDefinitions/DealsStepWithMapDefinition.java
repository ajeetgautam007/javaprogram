...
// DataTable with Maps – parameterized deals creation
public class DealsStepWithMapDefinition {
    ...
    public void user_enters_contacts_details(DataTable dealData) {
        ...
        for (Map<String, String> data :
                dealData.asMaps(String.class, String.class)) {
            ...
            driver.findElement(By.id("probability"))
                    .sendKeys(data.get("probability"));
            driver.findElement(By.id("commission"))
                    .sendKeys(data.get("commission"));
            ...
            driver.findElement(
                    By.xpath("//a[contains(text(),'New Deal')]")
            ).click();
        }
    }
